...
async function main() {
  ...
  // Official 34 provincial-level administrative units under Resolution 202/2025/QH15,
  // effective from 12/06/2025.
  const vietnamProvinces = [
    { name: 'Hà Nội', slug: 'ha-noi', region: 'NORTH' },
    { name: 'Cao Bằng', slug: 'cao-bang', region: 'NORTH' },
    { name: 'Tuyên Quang', slug: 'tuyen-quang', region: 'NORTH' },
    { name: 'Lào Cai', slug: 'lao-cai', region: 'NORTH' },
    { name: 'Điện Biên', slug: 'dien-bien', region: 'NORTH' },
    { name: 'Lai Châu', slug: 'lai-chau', region: 'NORTH' },
    { name: 'Sơn La', slug: 'son-la', region: 'NORTH' },
    { name: 'Thái Nguyên', slug: 'thai-nguyen', region: 'NORTH' },
    { name: 'Lạng Sơn', slug: 'lang-son', region: 'NORTH' },
    { name: 'Quảng Ninh', slug: 'quang-ninh', region: 'NORTH' },
    { name: 'Bắc Ninh', slug: 'bac-ninh', region: 'NORTH' },
    { name: 'Phú Thọ', slug: 'phu-tho', region: 'NORTH' },
    { name: 'Hải Phòng', slug: 'hai-phong', region: 'NORTH' },
    { name: 'Hưng Yên', slug: 'hung-yen', region: 'NORTH' },
    { name: 'Ninh Bình', slug: 'ninh-binh', region: 'NORTH' },
    ...
    { name: 'Huế', slug: 'hue', region: 'CENTRAL' },
    ...
    { name: 'Đắk Lắk', slug: 'dak-lak', region: 'CENTRAL' },
    { name: 'Khánh Hòa', slug: 'khanh-hoa', region: 'CENTRAL' },
    { name: 'Lâm Đồng', slug: 'lam-dong', region: 'CENTRAL' },
    { name: 'Hồ Chí Minh', slug: 'ho-chi-minh', region: 'SOUTH' },
    { name: 'Đồng Nai', slug: 'dong-nai', region: 'SOUTH' },
    { name: 'Tây Ninh', slug: 'tay-ninh', region: 'SOUTH' },
    { name: 'Cần Thơ', slug: 'can-tho', region: 'SOUTH' },
    { name: 'Vĩnh Long', slug: 'vinh-long', region: 'SOUTH' },
    { name: 'Đồng Tháp', slug: 'dong-thap', region: 'SOUTH' },
    { name: 'Cà Mau', slug: 'ca-mau', region: 'SOUTH' },
    { name: 'An Giang', slug: 'an-giang', region: 'SOUTH' },
  ];

  const provinces = await Promise.all(
    vietnamProvinces.map((province) => prisma.province.create({
      data: { id: uuidv4(), ...province }
    }))
  );
  const provinceBySlug = Object.fromEntries(provinces.map((province) => [province.slug, province]));
  ...
  const destinations = [
    {
      ...
      provinceId: provinceBySlug['quang-ninh'].id,
    ...
    },
    {
      ...
      provinceId: provinceBySlug['lao-cai'].id,
    ...
    },
    {
      ...
      name: 'Phú Quốc',
      slug: 'phu-quoc',
      description: 'Phú Quốc là hòn đảo lớn nhất Việt Nam, thuộc tỉnh An Giang sau sắp xếp đơn vị hành chính cấp tỉnh năm 2025. Với những bãi biển cát trắng, nước biển trong xanh và hệ sinh thái phong phú, Phú Quốc được mệnh danh là "Đảo Ngọc" của Việt Nam.',
      shortDescription: 'Đảo Ngọc với bãi biển đẹp và hệ sinh thái đa dạng',
      address: 'Phú Quốc, An Giang',
      provinceId: provinceBySlug['an-giang'].id,
    ...
    },
    {
      ...
      provinceId: provinceBySlug['hue'].id,
    ...
    },
    {
      ...
      name: 'Hội An',
      slug: 'hoi-an',
      description: 'Hội An là một điểm đến du lịch thuộc thành phố Đà Nẵng, nổi tiếng với phố cổ được UNESCO công nhận là Di sản Văn hóa Thế giới. Thành phố giữ nguyên vẻ đẹp kiến trúc cổ với những ngôi nhà phố xá, đình chùa hàng trăm năm tuổi.',
      shortDescription: 'Phố cổ UNESCO với kiến trúc và văn hóa đặc sắc',
      address: 'Hội An, Đà Nẵng',
      provinceId: provinceBySlug['da-nang'].id,
      categoryId: categories[2].id,
      latitude: 15.8801,
      longitude: 108.3380,
    ...
    },
    {
      ...
      provinceId: provinceBySlug['khanh-hoa'].id,
      categoryId: categories[0].id,
      latitude: 12.2388,
      longitude: 109.1967,
    ...
    },
    {
      ...
      provinceId: provinceBySlug['lam-dong'].id,
    ...
    },
    {
      ...
      name: 'Mù Cang Chải',
      slug: 'mu-cang-chai',
      description: 'Mù Cang Chải là vùng cao thuộc tỉnh Lào Cai sau sắp xếp đơn vị hành chính cấp tỉnh năm 2025, nổi tiếng với những ruộng bậc thang trải dài trên sườn núi. Đây là một trong những điểm ngắm lúa chín đẹp nhất Việt Nam, thu hút du khách từ khắp nơi.',
      shortDescription: 'Điểm ngắm ruộng bậc thang đẹp nhất Việt Nam',
      address: 'Mù Cang Chải, Lào Cai',
      provinceId: provinceBySlug['lao-cai'].id,
      categoryId: categories[1].id,
      latitude: 21.8167,
      longitude: 104.4167,
    ...
    },
    {
      ...
      name: 'Vũng Tàu',
      slug: 'vung-tau',
      description: 'Vũng Tàu là điểm đến biển thuộc Thành phố Hồ Chí Minh sau sắp xếp đơn vị hành chính cấp tỉnh năm 2025, cách TP.HCM khoảng 125km. Thành phố nổi tiếng với các bãi biển đẹp, ngọn hải đăng cổ và là trung tâm công nghiệp dầu khí của Việt Nam.',
      shortDescription: 'Thành phố biển gần Sài Gòn với bãi tắm và ngọn hải đăng',
      address: 'Vũng Tàu, Thành phố Hồ Chí Minh',
      provinceId: provinceBySlug['ho-chi-minh'].id,
      categoryId: categories[0].id,
      latitude: 10.4059,
      longitude: 107.1313,
      bestTime: 'Quanh năm',
    ...
    },
    {
      ...
      provinceId: provinceBySlug['can-tho'].id,
      categoryId: categories[5].id,
      latitude: 10.0452,
      longitude: 105.7469,
    ...
    },
    {
      ...
      name: 'Mũi Né',
      slug: 'mui-ne',
      description: 'Mũi Né là một điểm đến du lịch biển thuộc tỉnh Lâm Đồng sau sắp xếp đơn vị hành chính cấp tỉnh năm 2025. Nơi đây nổi tiếng với các đồi cát vàng trải dài, bãi biển đẹp và là địa điểm lý tưởng cho các môn thể thao biển.',
      shortDescription: 'Thị trấn biển với đồi cát vàng và bãi tắm đẹp',
      address: 'Mũi Né, Lâm Đồng',
      provinceId: provinceBySlug['lam-dong'].id,
      categoryId: categories[0].id,
      latitude: 10.9341,
      longitude: 108.2705,
    ...
    },
    {
      ...
      name: 'Tam Đảo',
      slug: 'tam-dao',
      description: 'Tam Đảo là điểm nghỉ dưỡng vùng núi thuộc tỉnh Phú Thọ sau sắp xếp đơn vị hành chính cấp tỉnh năm 2025, nằm ở độ cao khoảng 900m so với mực nước biển. Thị trấn nổi tiếng với khí hậu mát mẻ, cảnh quan thiên nhiên đẹp và các công trình kiến trúc Pháp cổ.',
      shortDescription: 'Điểm nghỉ dưỡng vùng núi với kiến trúc Pháp cổ',
      address: 'Tam Đảo, Phú Thọ',
      provinceId: provinceBySlug['phu-tho'].id,
      categoryId: categories[1].id,
      latitude: 21.4447,
      longitude: 105.6428,

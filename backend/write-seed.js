...
async function main() {
  ...
  const officialProvinces = [
    { name: 'Ha Noi', slug: 'ha-noi', region: 'NORTH' },
    { name: 'Cao Bang', slug: 'cao-bang', region: 'NORTH' },
    { name: 'Tuyen Quang', slug: 'tuyen-quang', region: 'NORTH' },
    { name: 'Lao Cai', slug: 'lao-cai', region: 'NORTH' },
    { name: 'Dien Bien', slug: 'dien-bien', region: 'NORTH' },
    { name: 'Lai Chau', slug: 'lai-chau', region: 'NORTH' },
    { name: 'Son La', slug: 'son-la', region: 'NORTH' },
    { name: 'Thai Nguyen', slug: 'thai-nguyen', region: 'NORTH' },
    { name: 'Lang Son', slug: 'lang-son', region: 'NORTH' },
    { name: 'Quang Ninh', slug: 'quang-ninh', region: 'NORTH' },
    { name: 'Bac Ninh', slug: 'bac-ninh', region: 'NORTH' },
    { name: 'Phu Tho', slug: 'phu-tho', region: 'NORTH' },
    { name: 'Hai Phong', slug: 'hai-phong', region: 'NORTH' },
    { name: 'Hung Yen', slug: 'hung-yen', region: 'NORTH' },
    { name: 'Ninh Binh', slug: 'ninh-binh', region: 'NORTH' },
    { name: 'Thanh Hoa', slug: 'thanh-hoa', region: 'CENTRAL' },
    { name: 'Nghe An', slug: 'nghe-an', region: 'CENTRAL' },
    { name: 'Ha Tinh', slug: 'ha-tinh', region: 'CENTRAL' },
    { name: 'Quang Tri', slug: 'quang-tri', region: 'CENTRAL' },
    { name: 'Hue', slug: 'hue', region: 'CENTRAL' },
    { name: 'Da Nang', slug: 'da-nang', region: 'CENTRAL' },
    { name: 'Quang Ngai', slug: 'quang-ngai', region: 'CENTRAL' },
    { name: 'Gia Lai', slug: 'gia-lai', region: 'CENTRAL' },
    { name: 'Dak Lak', slug: 'dak-lak', region: 'CENTRAL' },
    { name: 'Khanh Hoa', slug: 'khanh-hoa', region: 'CENTRAL' },
    { name: 'Lam Dong', slug: 'lam-dong', region: 'CENTRAL' },
    { name: 'Ho Chi Minh', slug: 'ho-chi-minh', region: 'SOUTH' },
    { name: 'Dong Nai', slug: 'dong-nai', region: 'SOUTH' },
    { name: 'Tay Ninh', slug: 'tay-ninh', region: 'SOUTH' },
    { name: 'Can Tho', slug: 'can-tho', region: 'SOUTH' },
    { name: 'Vinh Long', slug: 'vinh-long', region: 'SOUTH' },
    { name: 'Dong Thap', slug: 'dong-thap', region: 'SOUTH' },
    { name: 'Ca Mau', slug: 'ca-mau', region: 'SOUTH' },
    { name: 'An Giang', slug: 'an-giang', region: 'SOUTH' },
  ];
  const provinces = await Promise.all(officialProvinces.map((province) =>
    prisma.province.upsert({ where: { slug: province.slug }, update: province, create: province })
  ));
  ...
  const destData = [
    ...
    { name: 'Sapa', slug: 'sa-pa', provinceSlug: 'lao-cai', catSlug: 'nui-rung', shortDesc: 'Thi tran tren cao nguyen voi ruong bac thang va nui non hung vi', address: 'Thi tran Sapa, Lao Cai', bestTime: 'Thang 9 - Thang 11', estimatedCost: '2.000.000 - 5.000.000 VND', rating: 4.7, reviewCount: 198, viewCount: 9800, isFeatured: true, highlights: JSON.stringify(['Ruong bac thang Muong Hoa', 'Dinh Fansipan', 'Ban Cat Cat', 'Nui Ham Rong']) },
    { name: 'Co do Hue', slug: 'co-do-hue', provinceSlug: 'hue', catSlug: 'di-tich', shortDesc: 'Kinh do trieu Nguyen voi Hoang thanh va lang tam nga ngay', address: 'Thanh pho Hue', bestTime: 'Thang 1 - Thang 4', estimatedCost: '800.000 - 2.000.000 VND', rating: 4.6, reviewCount: 167, viewCount: 8200, isFeatured: true, highlights: JSON.stringify(['Hoang thanh', 'Lang Minh Mang', 'Chua Thien Mu', 'Dai Noi']) },
    { name: 'Phong Nha - Ke Bang', slug: 'phong-nha-ke-bang', provinceSlug: 'quang-tri', catSlug: 'thien-nhien', shortDesc: 'He thong hang dong lon nhat the gioi voi hang Son Doong', address: 'Bo Trach, Quang Tri', bestTime: 'Thang 2 - Thang 8', estimatedCost: '1.000.000 - 3.500.000 VND', rating: 4.9, reviewCount: 156, viewCount: 7600, isFeatured: true, highlights: JSON.stringify(['Dong Phong Nha', 'Hang Son Doong', 'Song ngam', 'Bai Da']) },
    ...
    { name: 'Hoi An', slug: 'hoi-an', provinceSlug: 'da-nang', catSlug: 'di-tich', shortDesc: 'Pho co UNESCO voi kien truc den long va am thuc doc dao', address: 'Hoi An, Da Nang', bestTime: 'Thang 2 - Thang 4', estimatedCost: '800.000 - 2.500.000 VND', rating: 4.8, reviewCount: 312, viewCount: 16500, isFeatured: true, highlights: JSON.stringify(['Pho co Hoi An', 'Cau Nhat Ban', 'Hoi quan Phuc Kien', 'Bai bien Cua Dai']) },
    ...
    { name: 'Mui Ne', slug: 'mui-ne', provinceSlug: 'lam-dong', catSlug: 'bien', shortDesc: 'Khu nghi mat bien voi dun cat vang va kitesurfing', address: 'Mui Ne, Lam Dong', bestTime: 'Thang 1 - Thang 8', estimatedCost: '800.000 - 3.000.000 VND', rating: 4.4, reviewCount: 178, viewCount: 8500, isFeatured: true, highlights: JSON.stringify(['Dun cat Mui Ne', 'Bai da Duyen My', 'Kitesurfing', 'Lang chai Mui Ne']) },
    ...
    { name: 'Vung Tau', slug: 'vung-tau', provinceSlug: 'ho-chi-minh', catSlug: 'bien', shortDesc: 'Thanh pho bien gan Sai Gon voi tuong Chua Kit o va am thuc', address: 'Vung Tau, TP. Ho Chi Minh', bestTime: 'Thang 1 - Thang 9', estimatedCost: '500.000 - 2.000.000 VND', rating: 4.4, reviewCount: 189, viewCount: 8900, isFeatured: false, highlights: JSON.stringify(['Tuong Chua Kit o', 'Bai Sau', 'Mui Nghinh Phong', 'Ben cang Song Hau']) },
    { name: 'Con Dao', slug: 'con-dao', provinceSlug: 'ho-chi-minh', catSlug: 'bien', shortDesc: 'Quan dao hoang so voi bai bien dep va lich su tu dao', address: 'Con Dao, TP. Ho Chi Minh', bestTime: 'Thang 3 - Thang 9', estimatedCost: '3.000.000 - 8.000.000 VND', rating: 4.9, reviewCount: 87, viewCount: 5100, isFeatured: false, highlights: JSON.stringify(['Bai Dam', 'Nghia trang Hang Duong', 'Hon Bay Canh', 'Lan ngam san ho']) },
    { name: 'Bac Lieu', slug: 'bac-lieu', provinceSlug: 'ca-mau', catSlug: 'thien-nhien', shortDesc: 'Canh dong gio voi coi xay va nha Cong tu Bac Lieu', address: 'Bac Lieu, Ca Mau', bestTime: 'Thang 12 - Thang 4', estimatedCost: '400.000 - 1.200.000 VND', rating: 4.3, reviewCount: 65, viewCount: 3200, isFeatured: false, highlights: JSON.stringify(['Canh dong gio', 'Nha Cong tu', 'Khu du lich Nha Mat', 'Chua Doi']) },
    { name: 'Ban Cat Cat', slug: 'ban-cat-cat', provinceSlug: 'lao-cai', catSlug: 'lang-nghe', shortDesc: 'Ban lang H_Mong co voi thac nuoc va ruong bac thang', address: 'Sapa, Lao Cai', bestTime: 'Thang 9 - Thang 11', estimatedCost: '500.000 - 1.500.000 VND', rating: 4.5, reviewCount: 112, viewCount: 5400, isFeatured: false, highlights: JSON.stringify(['Thac Cat Cat', 'Cay may', 'Nha trinh tuong', 'Det vai truyen thong']) },
    { name: 'Dao Ly Son', slug: 'dao-ly-son', provinceSlug: 'quang-ngai', catSlug: 'bien', shortDesc: 'Hon dao hoang so voi san ho va hai san tuoi ngon', address: 'Ly Son, Quang Ngai', bestTime: 'Thang 4 - Thang 8', estimatedCost: '1.000.000 - 2.500.000 VND', rating: 4.6, reviewCount: 78, viewCount: 4100, isFeatured: false, highlights: JSON.stringify(['Bai Binh', 'Hon Mu Cu', 'Mieu An Vinh', 'Hon Be']) },
    ...
    { name: 'Quy Nhon', slug: 'quy-nhon', provinceSlug: 'gia-lai', catSlug: 'bien', shortDesc: 'Thanh pho bien yen binh voi dao Hon Kho va am thuc', address: 'Quy Nhon, Gia Lai', bestTime: 'Thang 3 - Thang 8', estimatedCost: '800.000 - 2.000.000 VND', rating: 4.5, reviewCount: 123, viewCount: 5600, isFeatured: false, highlights: JSON.stringify(['Bai bien Quy Nhon', 'Dao Hon Kho', 'Eo Gio', 'Chua Ong Nun']) },
    { name: 'Chau Doc - Nui Cam', slug: 'nui-cam-chau-doc', provinceSlug: 'an-giang', catSlug: 'nui-rung', shortDesc: 'Nui Cam voi tuong Phat Ba Quan Am lon nhat Dong Nam A', address: 'Chau Doc, An Giang', bestTime: 'Thang 11 - Thang 4', estimatedCost: '600.000 - 1.500.000 VND', rating: 4.5, reviewCount: 98, viewCount: 4800, isFeatured: false, highlights: JSON.stringify(['Nui Cam', 'Chua Van Linh', 'Mieu Ba Chua Xu', 'Cho Chau Doc']) },
    ...
    { name: 'Moc Chau', slug: 'moc-chau', provinceSlug: 'son-la', catSlug: 'nui-rung', shortDesc: 'Cao nguyen voi doi che xanh va hoa ban noi trang', address: 'Moc Chau, Son La', bestTime: 'Thang 3 - Thang 5', estimatedCost: '800.000 - 2.500.000 VND', rating: 4.6, reviewCount: 145, viewCount: 7000, isFeatured: false, highlights: JSON.stringify(['Doi che Tan Lap', 'Thung lung hoa', 'Vuon dau tay', 'Dinh Pha Den']) },
    ...
    { name: 'Vinh Hy - Ca Na', slug: 'vinh-hy-ca-na', provinceSlug: 'khanh-hoa', catSlug: 'bien', shortDesc: 'Vinh hoang so voi kayak, lan san ho va hai san', address: 'Ninh Hai, Khanh Hoa', bestTime: 'Thang 3 - Thang 9', estimatedCost: '800.000 - 2.000.000 VND', rating: 4.7, reviewCount: 94, viewCount: 4600, isFeatured: false, highlights: JSON.stringify(['Vinh Vinh Hy', 'Lan ngam san ho', 'Ruong muoi', 'Diem cau ca']) },
